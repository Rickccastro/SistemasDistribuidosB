...
public class HealthCheckController {
    ...
    public String geraRandomB(@PathVariable String nameC) throws URISyntaxException{
    	...
    	/*consegue acessar o client C*/
    	 List<InstanceInfo> instances = eurekaClient.getInstancesById(nameC);
    	 
    	 /*pega a instancia que foi passada "PC-RIC:demo-eureka-client-c:8083"*/
         InstanceInfo instance = instances.getFirst();
         
         /*monta a URI usando a instancia como parametro / o metodo da classe*/
         HttpRequest request = HttpRequest.newBuilder()
                 .uri(new URI("http://"+instance.getIPAddr() + ":" + instance.getPort()+"/geraNumeroAleatorioC"))
                 .GET()
                 .build();
